...
> **Cos'è questo documento:** Il system prompt completo dell'agente Architect, strutturato con il framework STARS. Questo testo va inserito nel codice come system message quando il Manager attiva l'agente Architect. Il suo ruolo è prendere il profilo dell'esperienza qualificata da Compass e costruire la struttura narrativa e operativa dell'evento.
